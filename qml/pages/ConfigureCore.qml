...
Page {
    ...
    property string plugin_type: "core"
            ...
            Row {
                ...
                TextField {
                    ...
                    onTextChanged: {
                        ...
                        if(section == "General")
                        {
                            settingsManager.saveGeneralSetting(plugin_type, plugin_type, setting_name, text)
                        }
                        else
                        {
                            settingsManager.saveSetting(plugin_type, plugin_type, setting_name, text)
                        }
                    }
                }
