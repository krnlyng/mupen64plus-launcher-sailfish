...
Page {
    ...
    property string plugin_type: "rsp"
    ...
    function loadPossibleSettings() {
        ...
        for(var setting in general_settings) {
            console.log('###', "possible general setting: " + general_settings[setting] + " " + settingsManager.getSettingType(plugin_type, plugin_type, plugin_name, general_settings[setting]))
